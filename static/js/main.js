...
(() => {
  ...
  const portrait=document.querySelector('.about-photo img'); if(portrait) portrait.src='./static/images/profile.jpg';
  ...
  const currentStats=[['85','Days of Cloud & Security'],['3','Live Enthernet Platforms'],['9','Roadmap Phases'],['100','Day Engineering Target']];
